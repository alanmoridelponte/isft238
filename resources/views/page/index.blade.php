...
@section('content')
    <section class="relative h-[calc(100vh-96px)] md:h-[calc(100vh-100px)] w-full overflow-hidden">
        ...
        <div class="absolute z-20 left-0 top-1/4 transform -translate-y-1/4 w-[85%] md:w-[67%] lg:w-[70%] xl:w-[55%]">
            ...
            <section
                class="bg-gradient-to-r from-blue-50 via-green-50 to-amber-50 pt-4 pb-6 pl-8 pr-6 shadow-2xl rounded-br-lg">
                <div class="max-w-4xl mx-auto text-left">
                    <p
                        class="text-lg md:text-xl text-semibold bg-gradient-to-r from-blue-800 via-emerald-600 via-55% to-amber-600 to-75% bg-clip-text text-transparent">
    ...
    <section class="py-16 bg-gradient-to-b to-natural-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2
                    class="text-3xl font-bold bg-gradient-to-r from-blue-800 via-green-800 to-amber-800 bg-clip-text text-transparent">
    ...
    <section class="py-16 bg-gradient-to-b to-natural-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                <h2
                    class="text-3xl font-bold bg-gradient-to-r from-blue-800 via-amber-800 to-green-800 bg-clip-text text-transparent">
