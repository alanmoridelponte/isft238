...
<section class="py-16 bg-white">
   <div class="container mx-auto px-4">
      <div class="text-center mb-12">
         ...
         <p class="text-gray-600 mt-2">Formamos profesionales técnicos con las competencias que el mercado demanda</p>
      </div>
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
         <div class="bg-blue-50 p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            ...
            <p class="text-gray-600">Todas nuestras carreras cuentan con reconocimiento oficial y validez nacional.</p>
         </div>
         <div class="bg-green-50 p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            ...
            <p class="text-gray-600">Formación orientada a las necesidades reales del mercado laboral actual.</p>
         </div>
         <div class="bg-amber-50 p-6 rounded-lg shadow-md hover:shadow-lg transition duration-300">
            ...
            <p class="text-gray-600">Profesionales en actividad que transmiten experiencia real y conocimientos actualizados.</p>
         </div>
      </div>
   </div>
</section>
<x-public.careers-list>
   <div class="text-center mb-12">
      <h2 class="text-3xl font-bold font-bold bg-gradient-to-r from-blue-800 via-green-800 to-amber-800 bg-clip-text text-transparent">Nuestras Carreras</h2>
