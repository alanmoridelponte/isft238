                ...
                Forms\Components\Section::make('Redes sociales')
                    ...
                    ->schema([
                        ...
                        TextInput::make('institute_instagram')
                            ...
                            ->dehydrateStateUsing(fn($state) => $state ?: '')
                            ->dehydrated(),
                        TextInput::make('institute_twitter')
                            ->label('Twitter del instituto')
                            ->placeholder('Ingrese Twitter del instituto')
                            ->url()
                            ->maxLength(255)
                            ->dehydrateStateUsing(fn($state) => $state ?: '')
                            ->dehydrated(),
                        ...
                        TextInput::make('institute_whatsapp')
                            ...
                            ->dehydrateStateUsing(fn($state) => $state ?: '')
                            ->dehydrated(),
                        TextInput::make('institute_linkedin')
                            ->label('Linkedin del instituto')
                            ->placeholder('Ingrese Linkedin del instituto')
                            ->url()
                            ->maxLength(255)
                            ->dehydrateStateUsing(fn($state) => $state ?: '')
                            ->dehydrated(),
